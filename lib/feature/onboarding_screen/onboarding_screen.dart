...
import 'package:em_mobui/feature/ui_kit/card_with_text.dart';
import 'package:em_mobui/feature/ui_kit/filled_button_widget.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
              onPressed: () {
                context.router.popAndPush(MainRouteWidget());
              },
              icon: Icon(
                Icons.close,
