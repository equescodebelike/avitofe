...
class _$TestImpl implements _Test {
  const _$TestImpl({required this.id, required this.message});
  ...
  @override
  String toString() {
    return 'Test(id: $id, message: $message)';
  }
...
abstract class _Test implements Test {
  const factory _Test({required final int id, required final String message}) =
      _$TestImpl;
